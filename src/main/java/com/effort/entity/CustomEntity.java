...
public class CustomEntity {
	...
	@JsonProperty(access = Access.WRITE_ONLY)
	public static List<Columns> getCustomEntityColumns(){
		List<Columns> columns=new ArrayList<Columns>();
		Columns column=new Columns();
		column.setTitle("Form Id");column.setDataType("string");column.setDataIndx("formId");column.setWidth(150);columns.add(column);
		column=new Columns();column.setTitle("Custom Entity Id");column.setDataType("string");column.setDataIndx("customEntityNo");column.setWidth(150);columns.add(column);
		column = new Columns();column.setTitle("Custom Entity Name");column.setDataType("string");column.setDataIndx("customEntityName");column.setWidth(150);columns.add(column);
		column = new Columns();column.setTitle("Custom Entity Title");column.setDataType("string");column.setDataIndx("identifier");column.setWidth(150);columns.add(column);
		return columns;
	}
	@Override
