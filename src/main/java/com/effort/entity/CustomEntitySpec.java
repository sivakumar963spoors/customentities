...
public class CustomEntitySpec implements Serializable  {
	...
	private int enableDynamicCustomImport;
	private String aliasName;
	private boolean enableAutoWorkCreation;
	...
	public int getEnableDynamicCustomImport() {
		return enableDynamicCustomImport;
	}

	public void setEnableDynamicCustomImport(int enableDynamicCustomImport) {
		this.enableDynamicCustomImport = enableDynamicCustomImport;
	}
	...
	public boolean isEnableAutoWorkCreation() {
		return enableAutoWorkCreation;
	}

	public void setEnableAutoWorkCreation(boolean enableAutoWorkCreation) {
		this.enableAutoWorkCreation = enableAutoWorkCreation;
	}
